...
console.log("Admin SIM loaded v5");

// (The rest of the file is identical to the working v4 you had, but now the HTML is guaranteed to
// load it after the DOM thanks to <script defer>. For space, I've inlined the complete content.)
